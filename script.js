...
const welcomeMessages = [
    "👋 नमस्ते! मैं नितीश कुमार श्रीवास्तव का AI असिस्टेंट हूं।",
...
3. प्रोफेशनल कोर्स सर्टिफिकेट्स:
   ...
   • स्किल डेवलपमेंट प्रोग्राम्स`;
    ...
    // NCC related queries
    if (message.includes('software engineering') || message.includes('software engineering') || message.includes('engineering') || message.includes('bussainman')) {
        return `मेरा  अनुभव: web developer in bussainman software engineering
